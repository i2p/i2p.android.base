...
public class I2PNavDrawerBase extends ActionBarActivity {
    ...
    private void selectItem(int pos) {
        switch (pos) {
        case 1:
            Intent ab = new Intent(I2PNavDrawerBase.this, AddressbookActivity.class);
            startActivity(ab);
            break;
        case 2:
            Intent itb = new Intent(I2PNavDrawerBase.this, TunnelListActivity.class);
            startActivity(itb);
            break;
        case 3:
            Intent log = new Intent(I2PNavDrawerBase.this, LogActivity.class);
            startActivity(log);
            break;
        case 4:
            Intent err = new Intent(I2PNavDrawerBase.this, LogActivity.class);
            err.putExtra(LogActivity.ERRORS_ONLY, true);
            startActivity(err);
            break;
        default:
            Intent main = new Intent(I2PNavDrawerBase.this, MainActivity.class);
            startActivity(main);
            break;
        }
